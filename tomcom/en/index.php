        ...
        <div class="row content-row">
            ...
            <div class="main">
                <section class="featured-section">
                    ...
                    <img src="../immagini/LOGO_banner_ita_orig.jpg" alt="NATURAL PHILOSOPHY" class="featured-img">
                    <h3>NATURAL PHILOSOPHY</h3>
                    <h6>In progress...</h6>
                    <p>A project I will start soon, dedicated to communication and scientific outreach, and to spreading the practice of <abbr title="From Pali 'Vipassana' ('Profound Vision'/'seeing things as they really are')">vipassana</abbr> meditation. Spiritual practice, philosophical thought and scientific attitude can be one and the same in harmony and without friction.</p>
                </section>
