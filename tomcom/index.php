...
<body>
    ...
    <footer class="footer">
        <div class="social-links">
            <a href="https://x.com/TomasoZanardi" class="social-link" target="_blank" aria-label="Twitter">
                <svg class="social-icon" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
            </a>
            <a href="https://instagram.com/giacomo_piselli_fioroni" class="social-link" target="_blank" aria-label="Instagram">
                <svg class="social-icon" viewBox="0 0 24 24">
            ...
            <a href="https://open.spotify.com/user/yourusername" class="social-link" target="_blank" aria-label="Spotify">
                <svg class="social-icon" viewBox="0 0 24 24">
        ...
        <div>
            <p style="text-align: center;">
                <span style="display: inline-block; transform: rotate(180deg);">©</span> Copyleft Tomaso Zanardi: <a href="tomasozanardi.com" style="color: lightgreen;">www.tomasozanardi.com</a>
            </p>
        </div>
    </footer>
